export const data = {
  ...
  ERROR_RECORDING: "An error occured while recording.",
  ...
  SHAZAM_API_ERROR:
    "An error occured while connecting to shazam service. Try later.",
  SHAZARR_NOT_FOUND: "Song not found. Get closer ;)",
